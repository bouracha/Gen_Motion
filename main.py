...
parser.add_argument('--encoder_hidden_layers', nargs='+', type=str, default=[500, 200, 100, 50], help='input the out of distribution action')
...
for i in range(n_hidden):
    ...
    decoder_layers.append(n_hidden-1-i)
